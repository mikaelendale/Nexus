<x-app-layout>
    ...
    <h3 class="text-lg leading-6 font-medium text-gray-900 dark:text-gray-100">Submit a Project</h3>
    <form action="{{ route('projects.store') }}" method="POST">
        @csrf
        <input type="hidden" name="volunteer_org_id" value="{{ $onlineVolunteerOrg->id }}">
        <div>
            <label for="project_name">Project Name</label>
            <input type="text" name="project_name" id="project_name" class="block w-full mt-1" required>
        </div>

        <div class="mt-4">
            <label for="project_description">Project Description</label>
            <textarea name="project_description" id="project_description" class="block w-full mt-1" required></textarea>
        </div>
    ...
    <h3 class="text-lg leading-6 font-medium text-gray-900 dark:text-gray-100 mt-8">Completed Projects</h3>
    <ul>
